...
Public Class frmPayMultipleReceipts
    ...
    Sub LoadCreditorDetails(ByVal dgv As DataGridView, ByVal customerno As Integer)
        ...
        Dim strsql As String = "SELECT C.entryid,C.receiptno,C.totalamount,C.amountpaid," _
                               ...
                               & " AS BAL,C.datedue,1 FROM creditsales C " _
        ...
        Next
        txtCreditsTotal.Text = FormatCurrency(CreditsTotal.ToString, 0)
    ...
    Private Sub btnProcess_Click(sender As Object, e As EventArgs) Handles btnProcess.Click
        ...
        For i = 0 To dgvPayMultipleReceipts.RowCount - 1
            ...
            If (amount_to_pay > 0) Then
                sale.creditupdationdetails(receiptNo, fullnames, amount_to_pay, Now())

                'INSERT INTO CASH LEDGER
                CashLedger(receiptNo, "Customer Invoice Payment", 1, amount_to_pay, Now(), userid, "Received by:" & fullname, "+", "Paymode via : Cash ", 1)
            End If
