...
Public Class PayCreditsSummary
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Strawberry.PayCreditsSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPayCreditsSummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PayCreditsSummary = New PayCreditsSummary()
        rpt.Site = Me.Site
        Return rpt
    End Function
