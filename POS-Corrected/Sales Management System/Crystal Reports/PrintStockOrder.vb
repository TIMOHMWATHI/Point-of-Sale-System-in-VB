...
Public Class PrintStockOrder
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Strawberry.PrintStockOrder.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPrintStockOrder
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PrintStockOrder = New PrintStockOrder()
        rpt.Site = Me.Site
        Return rpt
    End Function
