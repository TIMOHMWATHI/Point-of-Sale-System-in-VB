...
Public Class Receipt_Headers
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Strawberry.Receipt_Headers.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReceipt_Headers
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Receipt_Headers = New Receipt_Headers()
        rpt.Site = Me.Site
        Return rpt
    End Function
