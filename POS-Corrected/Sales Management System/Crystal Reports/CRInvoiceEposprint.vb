...
Public Class CRInvoiceEposprint
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Strawberry.CRInvoiceEposprint.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRInvoiceEposprint
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRInvoiceEposprint = New CRInvoiceEposprint()
        rpt.Site = Me.Site
        Return rpt
    End Function
