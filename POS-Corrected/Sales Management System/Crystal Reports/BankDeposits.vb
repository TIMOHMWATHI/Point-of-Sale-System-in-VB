...
Public Class BankDeposits
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Strawberry.BankDeposits.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_dfrom() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_DepositTotals() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedBankDeposits
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BankDeposits = New BankDeposits()
        rpt.Site = Me.Site
        Return rpt
    End Function
