...
Public Class MilkDeliveryReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "POS_Corrected.MilkDeliveryReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMilkDeliveryReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MilkDeliveryReport = New MilkDeliveryReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
